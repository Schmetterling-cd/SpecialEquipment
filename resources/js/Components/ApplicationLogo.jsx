import logo from '../../../public/images/label.svg'

export default function ApplicationLogo(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#ffc107" className="bi bi-ev-front-fill" viewBox="0 0 16 16">
